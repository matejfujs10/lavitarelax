...
const translations: Record<Language, Record<string, string>> = {
  sl: {
    ...
    'hero.springAction': 'SEPTEMBER AKCIJA',
    'hero.springExtra': '3+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
    'hero.summerAction': 'POLETNA AKCIJA JULIJ, AVGUST',
    'hero.summerExtra': '3+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
    'hero.perNight': '/noč',
    ...
    'about.priceAdult': 'odrasli: 23,90 € na osebo na noč',
    'about.priceChild': 'otroci od 5 do 14,99 let: 19,90 €',
    ...
    // Booking
    'booking.springOffer': 'SEPTEMBER AKCIJA',
    'booking.springExtra': '3+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
    'booking.summerOffer': 'POLETNA AKCIJA JULIJ, AVGUST',
    'booking.summerExtra': '3+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
  ...
  en: {
    ...
    'hero.springAction': 'SEPTEMBER SPECIAL',
    'hero.springExtra': '3+ nights extra deal · + 2 all-day spa tickets for every night of stay',
    'hero.summerAction': 'SUMMER SPECIAL JULY, AUGUST',
    'hero.summerExtra': '3+ nights extra deal · + 2 all-day spa tickets for every night of stay',
    'hero.perNight': '/night',
    ...
    'about.priceAdult': 'adults: €23.90 per person per night',
    'about.priceChild': 'children 5 to 14.99 years: €19.90',
    ...
    // Booking
    'booking.springOffer': 'SEPTEMBER SPECIAL',
    'booking.springExtra': '3+ nights extra deal · + 2 all-day spa tickets for every night of stay',
    'booking.summerOffer': 'SUMMER SPECIAL JULY, AUGUST',
    'booking.summerExtra': '3+ nights extra deal · + 2 all-day spa tickets for every night of stay',
  ...
  de: {
    ...
    'hero.springAction': 'SEPTEMBER AKTION',
    'hero.springExtra': '3+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
    'hero.summerAction': 'SOMMERAKTION JULI, AUGUST',
    'hero.summerExtra': '3+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
    'hero.perNight': '/Nacht',
    ...
    'about.priceAdult': 'Erwachsene: 23,90 € pro Person/Nacht',
    'about.priceChild': 'Kinder von 5 bis 14,99 Jahre: 19,90 €',
    ...
    // Booking
    'booking.springOffer': 'SEPTEMBER AKTION',
    'booking.springExtra': '3+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
    'booking.summerOffer': 'SOMMERAKTION JULI, AUGUST',
    'booking.summerExtra': '3+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
  ...
  hr: {
    ...
    'hero.springAction': 'RUJANSKA AKCIJA',
    'hero.springExtra': '3+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
    'hero.summerAction': 'LJETNA AKCIJA SRPANJ, KOLOVOZ',
    'hero.summerExtra': '3+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
    'hero.perNight': '/noć',
    ...
    'about.priceAdult': 'odrasli: 23,90 € po osobi po noći',
    'about.priceChild': 'djeca od 5 do 14,99 godina: 19,90 €',
    ...
    // Booking
    'booking.springOffer': 'RUJANSKA AKCIJA',
    'booking.springExtra': '3+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
    'booking.summerOffer': 'LJETNA AKCIJA SRPANJ, KOLOVOZ',
    'booking.summerExtra': '3+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
