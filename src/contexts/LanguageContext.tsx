...
const translations: Record<Language, Record<string, string>> = {
  sl: {
    ...
    'hero.springExtra': '4+ noči · + 2 kopalni karti/dan',
    'hero.summerAction': 'POLETNA AKCIJA JULIJ, AVGUST',
    'hero.summerExtra': '4+ noči · + 2 kopalni karti/dan',
    'hero.perNight': '/noč',
    ...
    'booking.springExtra': '4+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
    'booking.summerOffer': 'POLETNA AKCIJA JULIJ, AVGUST',
    'booking.summerExtra': '4+ nočitev dodatna akcija · + 2 celodnevni kopalni karti vsak dan bivanja',
  ...
  en: {
    ...
    'hero.springExtra': '4+ nights · + 2 spa tickets/day',
    'hero.summerAction': 'SUMMER SPECIAL JULY, AUGUST',
    'hero.summerExtra': '4+ nights · + 2 spa tickets/day',
    'hero.perNight': '/night',
    ...
    'booking.springExtra': '4+ nights extra deal · + 2 all-day spa tickets for every night of stay',
    'booking.summerOffer': 'SUMMER SPECIAL JULY, AUGUST',
    'booking.summerExtra': '4+ nights extra deal · + 2 all-day spa tickets for every night of stay',
  ...
  de: {
    ...
    'hero.springExtra': '4+ Nächte · + 2 Thermentickets/Tag',
    'hero.summerAction': 'SOMMERAKTION JULI, AUGUST',
    'hero.summerExtra': '4+ Nächte · + 2 Thermentickets/Tag',
    'hero.perNight': '/Nacht',
    ...
    'booking.springExtra': '4+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
    'booking.summerOffer': 'SOMMERAKTION JULI, AUGUST',
    'booking.summerExtra': '4+ Nächte Zusatzangebot · + 2 Ganztages-Thermen­tickets pro Übernachtung',
  ...
  hr: {
    ...
    'hero.springExtra': '4+ noći · + 2 kupaoničke karte/dan',
    'hero.summerAction': 'LJETNA AKCIJA SRPANJ, KOLOVOZ',
    'hero.summerExtra': '4+ noći · + 2 kupaoničke karte/dan',
    'hero.perNight': '/noć',
    ...
    'booking.springExtra': '4+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
    'booking.summerOffer': 'LJETNA AKCIJA SRPANJ, KOLOVOZ',
    'booking.summerExtra': '4+ noćenja dodatna akcija · + 2 cjelodnevne kupaoničke karte za svaki dan boravka',
